    ...
    <div class="col-md-12">
        <section class="panel panel-featured panel-featured-primary">
            <header class="panel-heading">
                <h4> Formulir Ubah Data Barang </h4>
            </header>
            <div class="panel-body">
                <form class="form-horizontal form-bordered" url="{{ url('warehouse/'.$data->id.'/edit') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="initial_stock" name="initial_stock" value="{{ $data->initial_stock }}">
